...
- (void) PrintSampleReceipt: (CDVInvokedUrlCommand*)command
{
    ...
    NSMutableString* message = [NSMutableString string];//[NSMutableString stringWithString:@"Error has Occured"];
    
    NSString *PrinterName = @"BT:PRNT Star";
    ...
    PrinterName = [dict objectForKey:@"printer"];
    
    [MiniPrinterFunctions PrintSampleReceiptWithPortname:PrinterName
...
- (void) QueryPrinter:(CDVInvokedUrlCommand *)command {
    NSLog(@"Finding ports");
...
- (void) CheckFirmwareVersion: (CDVInvokedUrlCommand*)command
{
    ...
    [MiniPrinterFunctions showFirmwareInformation:PrinterName
                                            portSettings:@"Portable;escpos"];
...
- (void) CheckStatus: (CDVInvokedUrlCommand*)command
{
    ...
    [MiniPrinterFunctions CheckStatusWithPortname:PrinterName
                                         portSettings:@"Portable;escpos"
                                        sensorSetting:NoDrawer];
...
- (void) PrintInvoice: (CDVInvokedUrlCommand*)command
{
    ...
    PrinterName = [command.arguments objectAtIndex:3];
    ...
    [self sendCommand:commands portName:PrinterName portSettings:@"Portable;escpos" timeoutMillis:10000 errorMessage:message];
